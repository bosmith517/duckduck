...
import { Video } from '@signalwire/js' // ONLY import Video from Browser SDK
import { supabase } from '../../../supabaseClient'

interface SignalWireVideoRoomFixedProps {
  token?: string
  roomName?: string
  userName?: string
...
export const SignalWireVideoRoomFixed: React.FC<SignalWireVideoRoomFixedProps> = ({
  token: providedToken,
  roomName,
  userName = 'Guest',
  onRoomJoined,
  ...
  const joinRoom = async (tokenToUse: string) => {
    ...
    try {
      console.log('🚀 Starting SignalWire connection with Browser SDK...')
      ...
      console.log('Creating Video.RoomSession with Browser SDK...')
      
      // Create room session using ONLY Browser SDK Video class
      ...
      roomSession.on('room.joined', (params) => {
        ...
        console.log('Room joined params:', params)
        setIsConnected(true)
      ...
      console.log(`✅ Successfully joined room in ${totalElapsed.toFixed(0)}ms total`)
...
export default SignalWireVideoRoomFixed