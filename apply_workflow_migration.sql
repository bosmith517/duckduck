-- Apply workflow automation migration manually
-- This is the content of 20250703000011_create_workflow_automation_system.sql
...
-- Using a dummy UUID for system templates (these will be tenant-specific in real usage)
('00000000-0000-0000-0000-000000000000', 'Job Status Update', 'email', 'job_status', 'Job Status Update: {{job_title}}', 
 'Hello {{contact_name}},\n\nYour job "{{job_title}}" status has been updated to: {{new_status}}\n\n{{status_message}}\n\nBest regards,\n{{company_name}}',
 '["contact_name", "job_title", "new_status", "status_message", "company_name"]', true),

('00000000-0000-0000-0000-000000000000', 'Payment Milestone Due', 'email', 'milestone', 'Payment Due: {{milestone_name}}', 
 'Hello {{contact_name}},\n\nA payment milestone is now due for your job "{{job_title}}":\n\nMilestone: {{milestone_name}}\nAmount: {{amount}}\nDue Date: {{due_date}}\n\nPlease contact us to arrange payment.\n\nBest regards,\n{{company_name}}',
 '["contact_name", "job_title", "milestone_name", "amount", "due_date", "company_name"]', true),

('00000000-0000-0000-0000-000000000000', 'Team Assignment', 'in_app', 'assignment', 'New Job Assignment', 
 'You have been assigned to job: {{job_title}}\nRole: {{role}}\nStart Date: {{start_date}}\n\n{{assignment_notes}}',
 '["job_title", "role", "start_date", "assignment_notes"]', true),

('00000000-0000-0000-0000-000000000000', 'Inspection Reminder', 'email', 'reminder', 'Inspection Reminder: {{inspection_type}}', 
 ...
 '["job_title", "inspection_type", "due_date", "job_address", "company_name"]', true),

('00000000-0000-0000-0000-000000000000', 'Quote Request Response', 'email', 'quote', 'Quote Request: {{request_title}}', 
 ...
 '["vendor_name", "request_title", "response_deadline", "delivery_date", "company_name"]', true);
