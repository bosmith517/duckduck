-- FIXED SAFE USER ROLES MIGRATION
...
-- Drop existing policies with same names if they exist, then recreate
...
BEGIN
  ...
  IF admin_count = 0 THEN
    RAISE WARNING 'No platform admin user found! Please update the email in step 10 to set your platform admin.';
  ELSE
...
BEGIN
  ...
  RAISE NOTICE '4. Run the verification queries above to confirm setup';
  RAISE NOTICE '5. Platform admin controls will now be hidden from contractor users';
END $$;