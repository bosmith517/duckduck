-- Create the system functions for secure tracking management (FIXED VERSION)
...
-- 4. Function to automatically update timestamps
...
-- 5. Function to clean up expired tracking sessions (DEACTIVATE ONLY, NEVER DELETE)
...
-- 6. Function for legal data exports (if needed for compliance)
...
-- 7. Create/recreate triggers safely
...
-- 8. Enable Realtime for the tracking table
...
AND routine_name LIKE '%tracking%' OR routine_name LIKE '%technician%'
